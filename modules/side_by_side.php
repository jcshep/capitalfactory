...
<div class="container side-by-side <?= $variant; ?>">
	<div class="<?php if ($variant == 'v4'): ?>row <?php else: ?>grid gap-sm<?php endif; ?>">
		<div class="col-text-container<?php if ($variant == 'v4'): ?> col-md-7<?php endif; ?>">
			<?php if ($variant == 'v4'): ?><div class="spacer-xxl d-none d-md-block"></div><?php endif; ?>
			<div class="p-60<?php if ($variant == 'v4'): ?> pr-0<?php endif; ?> col-text d-flex flex-column align-items-start rounded-corners-1<?php if ($variant == 'v1' || $variant == 'v2'): ?> bg-cream<?php endif; ?>">
				<?php if ($args['tag']): ?>
	...
	<!-- Style -->
	<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/modules/side_by_side.css">