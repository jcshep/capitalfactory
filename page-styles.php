...
<div class="container">
	<div class="p-45 bg-white rounded-corners-1">
		...
		<div class="display-sm">.DISPLAY-SM</div>
		<div class="display-xs">.DISPLAY-XS</div>
		...
		&nbsp;&nbsp;
		<div class="btn btn-primary btn-md">.btn-primary.btn-md</div>
		<div class="spacer-md"></div>
		<div class="btn btn-outline-yellow">.btn-primary</div>
