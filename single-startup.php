    ...
    <div class="container">
        ...
        <div class="inside">
            ...
            <div class="content-wrap p-45 d-flex justify-content-center flex-column align-items-center position-relative h-100 variation-centered">
                ...
                <?php
                $funds = get_the_terms(get_the_ID(), 'fund');
                if ($funds && !is_wp_error($funds)) {
                    echo '<div class="d-flex">';
                    foreach ($funds as $fund) {
                        echo '<div class="tag bd-white d-inline-block mx-2">' . esc_html($fund->name) . '</div>';
                    }
                    echo '</div>';
                }
                ?>
    ...
    <div id="company" class="p-60 rounded-corners-1 bg-cream">
        <div class="row align-items-start">
            ...
            <div class="col-md-12 col-right">
                ...
                if ($email) :
                ?>
                    <a href="mailto:<?php echo esc_attr($email); ?>" class="btn btn-primary">Connect With Us</a>
                <?php endif; ?>
                <div class="spacer-xl"></div>
            </div>
            <div class="col-12">
            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
                <ul class="tags">
                    ...
                    ?>
                    <?php
                    $industries = get_the_terms(get_the_ID(), 'startup-industry');
